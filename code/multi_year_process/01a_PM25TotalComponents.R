...
##              This script is the same as that included in the overall code
##              directory
...
##    for future joins of PM2.5 measures, running as bash by year (this file!)
...
#
# These inputs are necessary for processing multiple years of data. Running all
# years at once will likely be too large for a typical compute space.
#
